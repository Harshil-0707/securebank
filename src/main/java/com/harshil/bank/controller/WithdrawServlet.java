...
@WebServlet("/bank/dashboard/withdraw/api/")
public class WithdrawServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        TransactionData transactionData = WithdrawServlet.mapper.readValue(json,TransactionData.class);

        transactionData.setUserId(userId);

        String error = bs.withdraw(transactionData);
